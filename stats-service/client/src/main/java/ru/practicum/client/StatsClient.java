...
public class StatsClient extends BaseClient {
    ...
    public ResponseEntity<Object> createHit(HitDto hitRequestDto) {
    ...
    public List<StatsDto> getStats(LocalDateTime start, LocalDateTime end,
        ...
        ResponseEntity<List<StatsDto>> response = rest.exchange(API_PREFIX_START + query,
                HttpMethod.GET, null,
                new ParameterizedTypeReference<>() {
                }, parameters);
        List<StatsDto> result = response.getBody();
